...
export const UsersList = () => {
    ...
    return (
        <section className="galeria col-12 d-flex flex-column align-items-center order-0 order-md-1 p-4 mb-2 w-100">
            <div className="table-responsive w-100">
                ...
                <div className='usuarios-contenedor mb-2'>
                    {cargando
                        ...
                        : (
                            // <div>
                            //     <Table bordered hover className="align-middle text-center fade-in">
                            ...
                            //                         <td>
                            //                             <Link className='btn general_btn me-2' to={`/admin/edit_user/${usuario._id}`}>
                            //                                 Editar Usuario
                            //                             </Link>
                            //                             <Button
                            //                                 variant="danger"
                                        ...
                                        {usuarios.length === 0 ? (
                                            ...
                                            usuarios.map(usuario => (
                                                <tr key={usuario._id}>
                                                    ...
                                                    <td>{usuario.correo}</td>
                                                    <td>
                                                        <Link to={`/admin/edit_user/${usuario._id}`} className="btn general_btn me-2">Editar</Link>
                                                        <Button
                                                            variant="danger"
                                                            onClick={() => deleteUser(usuario._id)}
                                                        >
